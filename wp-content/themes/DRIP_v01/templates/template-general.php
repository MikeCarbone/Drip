<?php 
/*
	Template Name: General With Sidebar AHH
*/
    get_header();
?>
	<main class="content">
		<section class="article flex">
			<img class="article__img" src="img/2guysNoCountry.jpg">
			...
			<div class="sub-content flex">
				...
				<div class="sub-content__sidebar sidebar">
						...
						<div class="sidebar__section">
							<h1 class="sidebar__header">Related Articles</h1>
							<div class="sidebar__indent">
								<div class="sidebar__related">
									<a href="#">
										<img class="sidebar__img" src="img/2guysNoCountry.jpg">
										<h4 class="sidebar__related-header">Watch out for this guy</h4>
									</a>
								</div>
								<div class="sidebar__related">
									<a href="#">

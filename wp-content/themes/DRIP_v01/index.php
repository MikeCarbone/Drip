...
<main>
    <div class="hero flex">
      ...
      <img class="hero__img" src="https://media.wmagazine.com/photos/57d2f99424d0d1ef061db933/4:3/w_1536/1316.flip.covers.KANYE.image.jpg">
      <div class="hero__caption-zone flex">
        <h1 class="hero__title">Kanye West is the x king.</h1>
    ...
    <section class="two flex">
      <div class="trending trending-wrapper">
        ...
        <div class="article-list flex">
          <a class="article-listing flex" href="#">
            <img class="article-listing__img" src="https://media.wmagazine.com/photos/57d2f99424d0d1ef061db933/4:3/w_1536/1316.flip.covers.KANYE.image.jpg">
            <div class="article-listing__info">
              <h1 class="article-listing__title">Meet your new boss</h1>
              <h3 class="article-listing__caption">Elon Musk is changing the game - and you're apart of it.</h3>
              <h4 class="article-listing__date">Aug 12, 2018</h4>
            </div>
          </a>
          <a class="article-listing flex" href="#">
            <img class="article-listing__img" src="https://media.wmagazine.com/photos/57d2f99424d0d1ef061db933/4:3/w_1536/1316.flip.covers.KANYE.image.jpg">
    ...
    <div class="flex row">
      <section class="sub-article col-50">
        ...
        <div class="sub-article__overlay"></div>
        <div class="sub-article__caption-zone flex">
          <h1 class="sub-article__title">Kanye West is the fucking king.</h1>
          <div class="flex caption-bottom">
            <h4 class="main-caption">Read about how this guy is literally a fucking beast.</h4>
            <div class="button sub-article__button">
              <h4><a class="button-link" href="#">Read More</a></h4>
            </div>
          </div>
      ...
      <section class="sub-article col-50">
        <img class="sub-article__img" src="https://pmchollywoodlife.files.wordpress.com/2017/07/aaron-judge-5-things-to-know-ftr.jpg?w=620">
        <div class="sub-article__overlay"></div>
        <div class="sub-article__caption-zone flex">
          <h1 class="sub-article__title">Kanye West is the fucking king.</h1>
          <div class="flex caption-bottom">

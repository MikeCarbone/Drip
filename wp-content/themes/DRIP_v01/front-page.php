...
<!-- banner Page
    ==========================================-->
<section id="home-banner" style="background-image: url(<?php echo get_field('hero_img'); ?>);">
  <div class="content">
    <div class="container"  data-wow-duration="1s">
      ...
      <a class="btn btn-outline-default wow fadeInLeft" href="<?php echo get_field('hero_button_primary_url'); ?>"><?php echo get_field('hero_button_primary_label'); ?></a> <a class="btn btn-info chooser-btn wow fadeInRight" href="#">Start FREE Trial</a> </div>
  </div>
</section>
